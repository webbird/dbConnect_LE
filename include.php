...
if (! class_exists ( 'dbConnectLE' )) {
	...
	class dbConnectLE {
		 ...
		 *
		 * @deprecated - this old search feature is no longer supported!
		 * @return boolean
		 */
		public function sqlAddSearchFeature() {
		    trigger_error(sprintf('[%s - %s] The old WebsiteBaker search is no longer supported!', __METHOD__, __LINE__));
		} // sqlAddSearchFeature()
